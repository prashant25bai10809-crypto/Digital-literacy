...
**task-1-presentation/**
Contains files related to the digital literacy presentation.

**task-2-portfolio/**
Contains the personal portfolio link and portfolio screenshot.

**task-3-platforms/**
Contains the Google Form link, form screenshot, and Google Sheet response screenshot.

**task-4-email-etiquette/**
Contains the internship inquiry email and the social media do’s and don’ts checklist.
